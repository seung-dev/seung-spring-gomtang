CREATE OR REPLACE FUNCTION public.f_etf_etf0101_sql(req_json text)
 RETURNS TEXT
 LANGUAGE plpgsql
AS $function$
DECLARE
...
BEGIN
	...
	query_text := CONCAT(
		...
		, '      , kw10000.item_cnst::varchar'
		, '      , kw10000.item_stts::varchar'
		, '      , n0101.etf_type'
	...
	query_text := CONCAT(
		...
		, '          ON 1 = 1'
		, '          AND tr10001.item_code = n0101.item_code'
